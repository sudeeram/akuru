...
export interface Schemas {
  ...
  "FlashcardCardResponse": { "cardRef": string; "ordinal": number; "version": number; "front": string; "back"?: string | null; "status": string; "warnings": Array<string>; "source": { [key: string]: unknown; }; };
  "FlashcardCardUpdateRequest": { "front": string; "back": string; "decision": "review_required" | "approved" | "rejected"; };
  "FlashcardDeckResponse": { "deckRef": string; "topicRef": string; "topicCode": string; "topicTitle": string; "groupCode": string; "groupTitle": string; "subjectId": string; "title": string; "status": string; "contentVersion": number; "cardCount": number; "approvedCount": number; "reviewRequiredCount": number; "rejectedCount": number; "cards"?: Array<Schemas["FlashcardCardResponse"]>; "releasedAt"?: string | null; };
  "FlashcardGenerateRequest": { "topicRef": string; "cardLimit"?: number; "requestKey": string; };
  "FlashcardRatingRequest": { "rating": "again" | "difficult" | "good" | "easy"; "requestKey": string; };
  "FlashcardSessionResponse": { "sessionRef": string; "deck": Schemas["FlashcardDeckResponse"]; "status": string; "currentOrdinal": number; "reviewedCount": number; "totalCards": number; "currentCard": Schemas["FlashcardCardResponse"] | null; "answerRevealed"?: boolean; "schedulerVersion": string; "message": string; };
  "FlashcardSessionStartRequest": { "requestKey": string; };
...
export interface ApiOperations {
  ...
  "POST /api/v1/flashcards/admin/decks/generate": { request: Schemas["FlashcardGenerateRequest"]; response: Schemas["FlashcardDeckResponse"] };
  "GET /api/v1/flashcards/admin/decks/{deck_ref}": { request: unknown; response: Schemas["FlashcardDeckResponse"] };
  "PATCH /api/v1/flashcards/admin/decks/{deck_ref}/cards/{card_ref}": { request: Schemas["FlashcardCardUpdateRequest"]; response: Schemas["FlashcardDeckResponse"] };
  "POST /api/v1/flashcards/admin/decks/{deck_ref}/release": { request: unknown; response: Schemas["FlashcardDeckResponse"] };
