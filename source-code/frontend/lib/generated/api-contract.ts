...
export interface Schemas {
  ...
  "AssessmentQuestionResponse": { "id": string; "number": string; "prompt": string; "sharedStem": string; "marks": number; "equations": Array<unknown>; "assetIds": Array<unknown>; "sourceLocations": Array<unknown>; "unitIds": Array<unknown>; "topicRefs"?: Array<string>; "skills": Array<unknown>; "difficulty": string; "answer"?: string; "fileId"?: string | null; "saveRevision"?: number; "rubric"?: { [key: string]: unknown; } | null; "result"?: Schemas["AssessmentResultResponse"] | null; };
  ...
  "CoverageDiagnosticResponse": { "status": string; "message": string; "planVersion"?: number | null; "currentGrade"?: number | null; "currentTerm"?: number | null; "coveredUnits"?: Array<Schemas["PlanUnitResponse"]>; "coveredTopics"?: Array<Schemas["PlanTopicResponse"]>; "missingPeriods"?: Array<string>; };
  ...
  "EvidenceResponse": { "chunkId": string; "sourceType": string; "content": string; "documentId": string; "documentTitle": string; "page": number; "boundingBox": { [key: string]: unknown; }; "sourceAssetId": string | null; "sourceUrl": string; "unitId"?: string | null; "unitCode"?: string | null; "unitTitle"?: string | null; "topicRef"?: string | null; "topicCode"?: string | null; "topicTitle"?: string | null; "groupLabel"?: string | null; "groupCode"?: string | null; "groupTitle"?: string | null; "printedPage"?: string | null; "score"?: number | null; };
  ...
  "GroupResponse": { "groupRef": string; "code": string; "title": string; "summary": string; "sequence": number; "status": string; "topics": Array<Schemas["TopicResponse"]>; "removable": boolean; };
  ...
  "LearnerContextResponse": { "operationRef": string; "contextVersion": string; "generatedAt": string; "subjectId": string; "activeUnit"?: Schemas["PlanUnitResponse"] | null; "activeTopic"?: Schemas["PlanTopicResponse"] | null; "units"?: Array<Schemas["ContextUnit"]>; "topics"?: Array<Schemas["ContextTopic"]>; "evidence": Array<Schemas["ContextEvidence"]>; "providerContext": Schemas["ProviderLearnerContext"]; };
  ...
  "MasteryResponse": { "studentId": string; "units": Array<Schemas["UnitMasteryResponse"]>; "topics"?: Array<Schemas["TopicMasteryResponse"]>; "groups"?: Array<Schemas["GroupMasteryResponse"]>; };
  ...
  "NextUnitRecommendation": { "unit"?: Schemas["PlanUnitResponse"] | null; "topic"?: Schemas["PlanTopicResponse"] | null; "reason": string; "evidenceRefs": Array<string>; "activity": Schemas["RecommendationActivity"]; "requiresStudentAction"?: boolean; "moveAction": { [key: string]: unknown; }; };
  "NextUnitRequest": { "subjectId": string; "requestKey": string; };
  "NextUnitResponse": { "status": "ready" | "no_evidence" | "no_eligible_units"; "message": string; "algorithmVersion": string; "contextOperationRef"?: string | null; "contextVersion"?: string | null; "recommendation"?: Schemas["NextUnitRecommendation"] | null; "ranking"?: Array<Schemas["RankedUnit"]>; "tutorBrief"?: Schemas["TutorRecommendationBrief"] | null; };
  ...
  "PlanItemResponse": { "id": string; "subject": string; "unitId"?: string | null; "unitCode"?: string | null; "topic": string; "topicRef"?: string | null; "topicCode"?: string | null; "topicTitle"?: string | null; "groupLabel"?: string | null; "groupCode"?: string | null; "groupTitle"?: string | null; "activityType": string; "minutes": number; "reason": string; "source": string; "sourceUrl": string; "successCondition": string; "scheduledFor": string; "status": string; };
  "PlanPeriod": { "grade": number; "term": number; "unitIds"?: Array<string>; "topicRefs"?: Array<string>; };
  ...
  "ProviderLearnerContext": { "learnerRef": string; "subjectId": string; "activeUnitCode"?: string | null; "activeTopicCode"?: string | null; "contextVersion": string; "learningSignals": Array<{ [key: string]: unknown; }>; "recurringMistakes": Array<{ [key: string]: unknown; }>; "reviewedRecommendations": Array<{ [key: string]: unknown; }>; "plannedActivities": Array<{ [key: string]: unknown; }>; };
  ...
  "RankedUnit": { "unit"?: Schemas["PlanUnitResponse"] | null; "topic"?: Schemas["PlanTopicResponse"] | null; "score": number; "factors": Array<Schemas["RankingFactor"]>; "evidenceRefs": Array<string>; };
  ...
  "RecommendationResponse": { "id": string; "diagnosisId": string; "studentId": string; "subjectId": string; "unitId"?: string | null; "unitCode"?: string | null; "unitTitle"?: string | null; "topicRef"?: string | null; "topicCode"?: string | null; "topicTitle"?: string | null; "groupLabel"?: string | null; "groupCode"?: string | null; "groupTitle"?: string | null; "category": string; "description": string; "observedEvidence": Array<string>; "occurrenceCount": number; "activityType": string; "title": string; "reason": string; "action": string; "successCondition": string; "sourceTitle": string; "sourcePage": number; "sourceUrl": string; "questionId": string | null; "reviewStatus": string; "reviewReason": string; "createdAt": string; };
  ...
  "TopicPartBatchItem": { "filename": string; "contentType": string; "contentBase64": string; "role"?: string; "printedStartPage"?: string | null; "printedEndPage"?: string | null; "idempotencyKey": string; };
  ...
  "TutorCitation": { "citationRef": string; "documentVersion": number; "textbookTitle": string; "textbookEdition": string; "unitId"?: string | null; "unitCode"?: string | null; "unitTitle"?: string | null; "topicRef"?: string | null; "topicCode"?: string | null; "topicTitle"?: string | null; "groupLabel"?: string | null; "groupCode"?: string | null; "groupTitle"?: string | null; "contentKind": string; "passage": string; "pdfPageIndex": number; "pdfPageNumber": number; "printedPageLabel"?: string | null; "pageReference": string; "boundingBox": { [key: string]: unknown; }; "confidence": number; "assetRef": string; "sourceUrl": string; "assetUrl": string; };
  ...
  "TutorPracticeResponse": { "practiceRef": string; "status": "active" | "submitted"; "unitCode"?: string | null; "unitTitle"?: string | null; "topicRef"?: string | null; "topicCode"?: string | null; "topicTitle"?: string | null; "groupCode"?: string | null; "groupTitle"?: string | null; "question": Schemas["AssessmentQuestionResponse"]; "assetUrls"?: Array<string>; "hintCount": number; "latestHint"?: string | null; "feedbackVisible": boolean; "createdAt": string; "submittedAt"?: string | null; };
  ...
  "TutorRecommendationBrief": { "instruction": string; "fixedUnitId"?: string | null; "fixedTopicRef"?: string | null; "fixedReason": string; "evidenceRefs": Array<string>; };
  ...
  "TutorSessionResponse": { "sessionRef": string; "subjectId": string; "activeUnit"?: Schemas["PlanUnitResponse"] | null; "activeTopic"?: Schemas["PlanTopicResponse"] | null; "currentTutor": Schemas["TutorProfileResponse"]; "mode": "practice"; "status": "active" | "ended"; "startedAt": string; "endedAt"?: string | null; "turns"?: Array<Schemas["TutorTurnResponse"]>; "profileEvents"?: Array<Schemas["TutorProfileEventResponse"]>; "unitEvents"?: Array<Schemas["TutorUnitEventResponse"]>; "topicEvents"?: Array<Schemas["TutorTopicEventResponse"]>; };
  "TutorSessionStartRequest": { "subjectId": string; "unitId"?: string | null; "topicRef"?: string | null; "profileRef": string; "requestKey": string; };
  "TutorSessionSubjectOption": { "id": string; "name": string; "units": Array<Schemas["PlanUnitResponse"]>; "topics"?: Array<Schemas["PlanTopicResponse"]>; };
  ...
  "TutorSignalResponse": { "signalRef": string; "studentName": string; "subjectId": string; "unitCode"?: string | null; "unitTitle"?: string | null; "topicRef"?: string | null; "topicCode"?: string | null; "topicTitle"?: string | null; "category": string; "observation": string; "confidence": number; "evidenceCount": number; "promptName": string; "promptVersion": string; "createdAt": string; };
  ...
  "TutorSummaryResponse": { "summaryRef": string; "sessionRef": string; "studentName": string; "subjectId": string; "unitsCovered": Array<{ [key: string]: unknown; }>; "activities": Array<string>; "strengths": Array<string>; "difficulties": Array<string>; "suggestedNextSteps": Array<string>; "usage": { [key: string]: unknown; }; "createdAt": string; };
  "TutorSwitchProfileRequest": { "profileRef": string; "requestKey": string; };
  "TutorSwitchUnitRequest": { "unitId"?: string | null; "topicRef"?: string | null; "requestKey": string; };
  ...
  "TutorUnitEventResponse": { "fromUnit": Schemas["PlanUnitResponse"]; "toUnit": Schemas["PlanUnitResponse"]; "createdAt": string; };
