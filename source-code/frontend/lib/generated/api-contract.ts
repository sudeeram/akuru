...
export interface Schemas {
  ...
  "FlashcardMasteryCategory": { "category": string; "total": number; "toEvaluate": number; "needsReview": number; "good": number; "mastered": number; "coveragePercent": number; "masteryPercent": number; };
