...
export interface Schemas {
  ...
  "NextUnitRecommendation": { "unit": Schemas["PlanUnitResponse"]; "reason": string; "evidenceRefs": Array<string>; "activity": Schemas["RecommendationActivity"]; "requiresStudentAction"?: boolean; "moveAction": { [key: string]: unknown; }; };
  ...
  "ProviderLearnerContext": { "learnerRef": string; "subjectId": string; "activeUnitCode": string; "contextVersion": string; "learningSignals": Array<{ [key: string]: unknown; }>; "recurringMistakes": Array<{ [key: string]: unknown; }>; "reviewedRecommendations": Array<{ [key: string]: unknown; }>; "plannedActivities": Array<{ [key: string]: unknown; }>; };
  ...
  "RankedUnit": { "unit": Schemas["PlanUnitResponse"]; "score": number; "factors": Array<Schemas["RankingFactor"]>; "evidenceRefs": Array<string>; };
  ...
  "TutorRecommendationBrief": { "instruction": string; "fixedUnitId": string; "fixedReason": string; "evidenceRefs": Array<string>; };
