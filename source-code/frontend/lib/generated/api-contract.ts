...
export interface Schemas {
  ...
  "ExtractionBlockUpdateRequest": { "kind": string; "text"?: string; "latex"?: string | null; "caption"?: string | null; "sequenceNumber": number; };
  ...
  "FlashcardCardResponse": { "cardRef": string; "ordinal": number; "version": number; "front": string; "back"?: string | null; "status": string; "warnings": Array<string>; "source": { [key: string]: unknown; }; "conceptKey"?: string; "category"?: string; "variationType"?: string; "difficulty"?: string; };
  ...
  "FlashcardSessionResponse": { "sessionRef": string; "deck": Schemas["FlashcardDeckResponse"]; "status": string; "currentOrdinal": number; "reviewedCount": number; "totalCards": number; "currentCard": Schemas["FlashcardCardResponse"] | null; "answerRevealed"?: boolean; "schedulerVersion": string; "message": string; "mode"?: string; "selectionReasons"?: Array<string>; };
  "FlashcardSessionStartRequest": { "requestKey": string; "mode"?: "quick" | "normal" | "full_topic" | "difficult" | "due_today" | "unit_mixed"; };
  "FlashcardStudyOption": { "mode": "quick" | "normal" | "full_topic" | "difficult" | "due_today" | "unit_mixed"; "title": string; "description": string; "availableCount": number; "sessionSize": number; "enabled": boolean; };
  "FlashcardStudyOptionsResponse": { "deckRef": string; "options": Array<Schemas["FlashcardStudyOption"]>; "summary"?: { [key: string]: number; }; };
  "FlashcardWithdrawRequest": { "reason": string; };
...
export interface ApiOperations {
  ...
  "GET /api/v1/flashcards/student/decks/{deck_ref}/study-options": { request: unknown; response: Schemas["FlashcardStudyOptionsResponse"] };
