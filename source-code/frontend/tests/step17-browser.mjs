...
const unit={unitId:'u-test',unitCode:'M1',unitTitle:'Numbers',subjectId:'maths',score:7,preciseScore:7,confidence:'medium',provisional:false,evidenceCount:3,evidenceWeight:2,varietyCount:3,trend:1,lastEvidenceAt:'2026-09-14',dimensions:[{dimension:'method',score:7,evidenceWeight:2}],recentEvents:[{id:'e-test',previousScore:6,newScore:7,newConfidence:'medium',explanation:'More correct method marks',createdAt:'2026-09-14T10:00:00Z'}]};
...
const reviewBodies=[];
function state(){return {user:{id:role==='student'?child.id:role+'-test',name:'Test '+role,role,mustChangePassword:false},catalog:{courses:['iGCSE'],activeCourses:['iGCSE'],grades:['Grade 10'],terms:['Term2'],kinds:[],progressionPairs:[]},accounts:[],subjects:[{id:'maths',name:'Maths',color:'blue',icon:'∑',description:'Numbers'}],students:[child],units:[],coverage:[],questionBank:[],drafts:{},questions:[{id:'q-test',subject:'maths',topic:'Numbers',title:'Multiply',prompt:'Calculate the product.',marks:1,type:'written',diagram:'triangle',source:'Test fixture',assessmentId:'assessment-test',equations:['\\frac{1}{2}x^2'],assetIds:['asset-test']}],attempts:[attempt],assignments:[],documents:[],exams:[{id:'assessment-test',studentId:child.id,status:'active',mode:'practice',questionIds:['q-test'],answers:{},files:{}}],assessmentBlueprints:[],officialPapers:[],reviews:[],plans:{},mastery:{[child.id]:[unit]},recommendations:{}};}
